...
const UnBasicModal = ({ open, setOpen }) => {
            ...
            {open && (
                <div style={overlayStyle}>
                    <div style={modalStyle} className='bg-gray-900'>
                        <p className='my-4 text-white'>Dear user, we didn't find an account with matching details, please register now!</p>
                        <button
                            type="submit"
